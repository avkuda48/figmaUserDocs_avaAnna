...
![Dropdown menu of different shapes as options to create](imgs/task3-2-rectangleDropDown.png)
...
![Panel of options to align items](imgs/task3-3-alignment.png)
...
1. **Navigate** to the fill section of the appearance settings.
    ...
    ![Fill section with coloured square and hex code](imgs/task3-7.5-fill.png)
...
2. **Click and drag** the circle to the general colour you want on the top most rainbow slider.
    ...
    ![Slider input for colours](imgs/task3-8-colorSlider.png)

3. **Click and drag** the circle on the large colour graph to determine the colour’s lightness/darkness and saturation.

    ![Graph of variations of a colour](imgs/task3-9-colourgraph.png)
...
2. **Click** anywhere on the frame to begin drawing a shape.
    ...
    ![Two points with a line connecting them. The point under the cursor is an outline of a circle and the other point is solid](imgs/task3-12-point.png)
...
4. **Click** on your starting point to complete the shape.
    ...
    ![Closed shape comprised of three points](imgs/task3-idk-point.png)
...
![Point at the center of a curved line and a straight line with its own points to adjust curve](imgs/task3-13-handles.png)
